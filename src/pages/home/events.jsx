...
export default function Events(){
			...
			<aside id="sidebar">
				...
				<div className="widget list">
					...
					<div className="btn-holder">
						<a className="btn blue" href="#">Show more photos</a>
					</div>
				</div>
			</aside>	
		</div>
	...
	<footer id="footer">
		<div className="container">
			...
			<p className="copy">Copyright 2014 Harrison High School. Designed by <a href="http://www.vandelaydesign.com/" title="Designed by Vandelay Design" target="_blank" rel="noreferrer">Vandelay Design</a>. All rights reserved.</p>
		</div>
	</footer>
	...
	<div id="fancy">
		...
		<form action="#">
			<div className="left">
				<fieldset className="mail"><input placeholder="Email address..." type="text"/></fieldset>
				<fieldset className="name"><input placeholder="Name..." type="text"/></fieldset>
				<fieldset className="subject"><select><option>Choose subject...</option><option>Choose subject...</option><option>Choose subject...</option></select></fieldset>
			</div>
			<div className="right">
				<fieldset className="question"><textarea placeholder="Question..."></textarea></fieldset>
			</div>
			<div className="btn-holder">
				<button className="btn blue" type="submit">Send request</button>
			</div>
		</form>
	</div>
    </>
