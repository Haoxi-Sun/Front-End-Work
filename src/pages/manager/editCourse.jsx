...
import { Input, Select, Row, Col, Spin, Tabs, message } from 'antd';
import AddCourseForm from '../../components/manager/addCourseForm';
import { getCourses } from '../../api/api';
import _debounce from 'lodash.debounce';
import UpdateCourseSchedule from '../../components/manager/updateCourseSchedule';
const { Option } = Select;
const { TabPane } = Tabs;
    ...
    <>
      ...
      >
        ...
        <TabPane tab="Course Schedule" key="courseSchedule" style={{paddingLeft: "24px"}}>
            <UpdateCourseSchedule course={course} isAdd={false}/>
        </TabPane>
      </Tabs>
    </>
  );
